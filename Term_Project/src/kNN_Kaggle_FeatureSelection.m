...
data = [data(:,1),data(:,3),data(:,5),data(:,7),data(:,8),data(:,9),data(:,10),data(:,11)];
dataKaggle = load('challenge_public_test_classification_regression_2015.csv');
dataKaggle = dataKaggle(:,2:12);
dataKaggle = [dataKaggle(:,1),dataKaggle(:,3),dataKaggle(:,5),dataKaggle(:,7),dataKaggle(:,8),dataKaggle(:,9),dataKaggle(:,10),dataKaggle(:,11)];
